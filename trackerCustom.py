...
import sys
sys.path.append("..")
from SiamCustom import LightSiamAttention

class TrackerSiamAttention(Tracker):

    def __init__(self, net_path=None, **kargs):
        super(TrackerSiamAttention, self).__init__(name='LightSiamAttention', is_deterministic=True)
